    ...
    <div className="about">
      ...
      <div className="about-info">
        <div className="container">
          ...
          <p>
            I view my career as a continuously learning experience that evolves
            with each project and collaboration. With a dedication to
            functionality and a curiosity for what lies ahead, I strive to keep
            my work practical, relevant, and innovative. Please check out my
            past projects, and feel free to reach out with any questions.
          </p>
        </div>
      </div>
    </div>
